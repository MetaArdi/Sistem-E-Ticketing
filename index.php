    ...
    <main class="flex-grow max-w-7xl mx-auto w-full px-5 md:px-6 lg:px-8 pt-6 pb-12">
        ...
        <div class="mb-10 md:mb-12">
            ...
            <div
                ...
                if (empty($categories)) {
                    $categories = ['Music', 'Sports', 'Food', 'Arts'];
                }
                ...
                $icons = [
                    ...
                    'Arts' => '<path fill="none" stroke="currentColor" stroke-width="2" d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8z"></path>',
                ];
                ...
                foreach ($categories as $cat):
                    ...
                    $icon_svg = isset($icons[$cat]) ? $icons[$cat] : $default_icon;
                    ?>
                    <a href="<?= $url ?>"
