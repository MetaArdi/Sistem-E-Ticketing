...
<body
    ...
    <div class="w-full max-w-lg bg-white/90 backdrop-blur-xl rounded-[2.5rem] shadow-2xl shadow-slate-200/60 p-7 sm:p-10 relative z-10 border border-slate-100/80 my-auto transition-all duration-300">

        <!-- Top Header Navigation Bar (Kembali) -->
        <div class="flex items-center justify-between mb-6 pb-4 border-b border-slate-100/80">
            <a href="login.php" class="inline-flex items-center gap-2 text-xs font-bold text-slate-500 hover:text-primary transition-all bg-slate-100/80 hover:bg-slate-100 px-3.5 py-1.5 rounded-full border border-slate-200/60 group">
            ...
            <span class="text-[10px] font-extrabold uppercase tracking-widest text-slate-400">Daftar Akun</span>
        </div>
        ...
        <form action="proses_register.php" method="POST" class="space-y-5">
            ...
            <div class="space-y-1.5">
                <label class="text-[11px] font-extrabold text-slate-500 uppercase tracking-widest block">Nama
                    Lengkap</label>
                <div class="relative group">
                    ...
                    <input type="text" name="nama_lengkap" required placeholder="John Doe"
            ...
            <div class="space-y-1.5">
                <label class="text-[11px] font-extrabold text-slate-500 uppercase tracking-widest block">No. WhatsApp /
                    Telepon</label>
                <div class="relative group">
                    <div
                        class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none transition-colors group-focus-within:text-primary text-slate-400">
            ...
            <div class="space-y-1.5">
                ...
                <div class="relative group">
                    <div
                        class="absolute inset-y-0 left-0 pl-4 pt-3 pointer-events-none transition-colors group-focus-within:text-primary text-slate-400">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24"
                            stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <textarea name="alamat" required rows="2" placeholder="Jl. Contoh Alamat No. 123"
                        class="w-full pl-11 pr-5 py-3 bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-primary/20 focus:border-primary focus:bg-white transition-all text-sm font-semibold outline-none text-slate-800 placeholder-slate-400"></textarea>
                </div>
            </div>
            ...
            <div class="space-y-1.5">
                ...
                <div class="relative group">
                    ...
                    <input type="password" id="password_input" name="password" required placeholder="Minimal 6 karakter"
                        minlength="6"
            ...
            <div class="pt-4">
                <button type="submit"
                    class="w-full bg-primary hover:bg-slate-900 text-white font-bold py-3.5 px-6 rounded-xl transition-all duration-300 shadow-lg shadow-primary/20 hover:shadow-slate-900/30 hover:-translate-y-0.5 text-sm tracking-wide">
                    Daftar Akun
                </button>
            </div>
        </form>
        ...
        <div class="mt-6 text-center">
            <p class="text-sm text-slate-500 font-medium">
                Sudah punya akun? <a href="login.php"
                    class="text-primary font-bold hover:text-secondary transition-colors">Masuk di sini</a>
            </p>
        </div>
