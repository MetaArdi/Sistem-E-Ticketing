            ...
            if (files && files.length > 0) {
                ...
                reader.onload = function(event) {
                    ...
                    cropper = new Cropper(cropperSourceImage, {
                        ...
                        ready: function() {
                            // Reset zoom range based on current zoom
    ...
    if (saveCropper) {
        saveCropper.addEventListener('click', function() {
            if (cropper) {
                ...
                // Update main page previews (both header and main profile card)
                ...
                if (profileAvatarImg) {
                    ...
                    // Replace placeholder div with an image tag
                ...
                // Also update the small header profile picture if it exists
