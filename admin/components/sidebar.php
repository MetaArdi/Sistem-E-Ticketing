...
<aside id="sidebar" class="w-72 bg-slate-50 border-r border-slate-200 flex flex-col fixed inset-y-0 left-0 transform -translate-x-full md:relative md:translate-x-0 transition-all duration-300 ease-in-out z-50 shadow-lg md:shadow-none">
    ...
    <div class="h-20 flex items-center justify-between px-6 border-b border-slate-200 shrink-0">
        <a href="index.php" class="flex items-center gap-3 group">
            ...
            <span class="text-xl font-extrabold text-slate-900 tracking-tight">HaloTiket Admin</span>
            <?php endif; ?>
        </a>
    ...
    <nav class="flex-1 overflow-y-auto py-6 px-4 scrollbar-hide">
        ...
        <ul class="space-y-2">
            ...
            <li>
                <a href="manage_withdrawals.php" class="<?= $am == 'withdrawals' ? $active_class : $inactive_class ?> flex items-center px-4 py-3 rounded-xl transition-all duration-300 text-sm gap-4">
        ...
        <p class="px-4 text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-3 mt-8">Pengaturan & Akun</p>
        <ul class="space-y-2">
            <li>
        ...
        <p class="px-4 text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-3 mt-8">Sistem & Akses</p>
        <ul class="space-y-2">
            <li>
    ...
    <div class="p-4 border-t border-slate-200 shrink-0">
        <a href="<?= BASE_URL ?>auth/logout.php" onclick="return confirm('Apakah Anda yakin ingin keluar dari Admin Panel?')" class="flex items-center justify-center w-full px-4 py-3 text-sm font-bold text-red-500 bg-red-50 hover:bg-red-100 rounded-xl transition-colors border border-red-100">
