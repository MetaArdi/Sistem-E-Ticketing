...
<body class="bg-slate-50 font-sans antialiased text-slate-800 selection:bg-primary selection:text-white">
    ...
    <div>
        ...
        <div class="relative">
            ...
            <input type="text" name="nama_lengkap" class="w-full pl-9 pr-4 py-2 bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all text-sm font-medium" placeholder="John Doe" required>
        </div>
    </div>
    ...
    <div>
        ...
        <div class="relative">
            ...
            <input type="text" name="no_hp" class="w-full pl-9 pr-4 py-2 bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all text-sm font-medium" placeholder="08123456789">
        </div>
    </div>
    ...
    <div>
        ...
        <div class="relative">
            ...
            <input type="password" name="password" id="password" class="w-full pl-9 pr-10 py-2 bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all text-sm font-medium" placeholder="••••••••" required>
